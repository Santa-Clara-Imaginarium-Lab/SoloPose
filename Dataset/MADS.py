...
def plot_skeleton_3d(skeleton_data,num_person, output, min_x, max_x,min_y, max_y,min_z, max_z):
    ...
    # 15:11
    # 16:12
    joint_connections = [(1,6),(6,7),(7,8),(1,2),(2,3),(3,4),(1,0),(0,18),(0,14),(14,15),(15,16),(0,10),(10,11),(11,12),(12,13)]
...
if __name__ == '__main__':
    ...
    file_path = root_path + 'MADS/annot/MADS.pkl'

    test_uniform_system(root_path, file_path, 8)
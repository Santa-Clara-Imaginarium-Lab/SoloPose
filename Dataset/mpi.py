...
def plot_skeleton_3d(skeleton_data,num_person, output, min_x, max_x,min_y, max_y,min_z, max_z):
    def update_frame(frame_idx):
        ...
        for i in range(num_person):
            draw_list = [1,3,4,6,7,9,10,11,12,14,15,16,17,18,19,20,23,24,25]
    ...
    # 15:10
    # 16:11
    joint_connections = [(4,23),(23,24),(24,25),(4,18),(18,19),(19,20),(4,3),(3,1),(1,6),(6,7),(1,14),(14,15),(15,16),(1,9),(9,10),(10,11)]
...
if __name__ == '__main__':
    ...
    file_path = root_path + 'mpi_inf_3dhp_dataset/annot/mpi_inf_3dhp_dataset.pkl'

    test_uniform_system(root_path, file_path, 14*5)